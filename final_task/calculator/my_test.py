...
class TestCalc(unittest.TestCase):
    ...
    def test_errors(self):
        self.assertRaises(ValueError, evaluated, 'acosh(0.54)')
        self.assertRaises(ValueError, evaluated, 'acos(10)')
        self.assertRaises(ValueError, evaluated, 'asin(5)')
        self.assertRaises(ValueError, evaluated, 'atan2(5,4,3)')
        self.assertRaises(ValueError, evaluated, 'atan2(5)')
        self.assertRaises(ValueError, evaluated, 'atanh(5)')
        self.assertRaises(ValueError, evaluated, 'sqrt(-4)')
        self.assertRaises(ValueError, evaluated, '2/0')
        self.assertRaises(ValueError, evaluated, '')
        self.assertRaises(ValueError, evaluated, '+')
        self.assertRaises(ValueError, evaluated, '1-')
        self.assertRaises(ValueError, evaluated, '1 2')
        self.assertRaises(ValueError, evaluated, '==7')
        self.assertRaises(ValueError, evaluated, '1 + 2(3 * 4))')
        self.assertRaises(ValueError, evaluated, '((1+2)')
        self.assertRaises(ValueError, evaluated, '1 + 1 2 3 4 5 6')
        self.assertRaises(ValueError, evaluated, 'log100(100)')
        self.assertRaises(ValueError, evaluated, '------')
        self.assertRaises(ValueError, evaluated, '5 > = 6')
        self.assertRaises(ValueError, evaluated, '5 / / 6')
        self.assertRaises(ValueError, evaluated, '6 < = 6')
        self.assertRaises(ValueError, evaluated, '6 * * 6')
        self.assertRaises(ValueError, evaluated, '(((((')
        self.assertRaises(ValueError, evaluated, 'abs')
        self.assertRaises(ValueError, evaluated, 'pow(2, 3, 4)')
        self.assertRaises(ValueError, evaluated, '1.2.3 + 5')
        self.assertRaises(ValueError, evaluated, 'qwerty()', ['not_exist_module'])
